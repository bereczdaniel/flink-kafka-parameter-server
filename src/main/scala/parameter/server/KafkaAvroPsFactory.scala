...
/**
  ...
  */
class KafkaAvroPsFactory[T <: WorkerInput,
                      P <: Parameter,
                      WK, SK] {
  ...
  def createPs(
    ...
    new ParameterServer[T, P, WK, SK](
      ...
      serverToWorkerSink = new FlinkKafkaProducer011[String](kafkaServer, serverToWorkerTopic, new AvroMessageSerializer[SK,WK,P]()),
      serverToWorkerSource = new FlinkKafkaConsumer011[String](serverToWorkerTopic, new AvroMessageDeserializer[SK,WK,P](), properties).setStartFromLatest(),
      serverToWorkerParse = serverToWorkerParse,
      workerToServerSink = new FlinkKafkaProducer011[String](kafkaServer, workerToServerTopic, new AvroMessageSerializer[SK,WK,P]()),
      workerToServerSource = new FlinkKafkaConsumer011[String](workerToServerTopic, new AvroMessageDeserializer[SK,WK,P](), properties).setStartFromLatest(),
